...
describe('CellSizeAndPositionManager', function () {
  function getCellSizeAndPositionManager() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        cellSize = _ref$cellSize === void 0 ? function () {
      return 10;
    } : _ref$cellSize;
    ...
    var cellSizeGetterCalls = jest.spyOn(cellSizeAndPositionManager, '_getSize');
    return {
  ...
  describe('findNearestCell', function () {
    ...
    it('should find the first cell for numeric CellSize', function () {
    ...
    it('should find the first cell for thunk CellSize', function () {
    ...
    it('should find the last cell for numeric CellSize', function () {
    ...
    it('should find the last cell for thunk CellSize', function () {
    ...
    it('should find the a cell that exactly matches a specified offset in the middle, numeric CellSize', function () {
    ...
    it('should find the a cell that exactly matches a specified offset in the middle, thunk CellSize', function () {
    ...
    it('should find the cell closest to (but before) the specified offset in the middle, numeric CellSize', function () {
    ...
    it('should find the cell closest to (but before) the specified offset in the middle, thunk CellSize', function () {
  ...
  describe('getSizeAndPositionOfCell', function () {
    ...
    it('should return the correct size and position information for the requested cell, numeric CellSize', function () {
    ...
    it('should return the correct size and position information for the requested cell, thunk CellSize', function () {
    ...
    it('should only measure the necessary cells to return the information requested', function () {
      var _getCellSizeAndPositi15 = getCellSizeAndPositionManager(),
          ...
          cellSizeGetterCalls = _getCellSizeAndPositi15.cellSizeGetterCalls;
    ...
    it('should just-in-time measure all cells up to the requested cell if no cells have yet been measured', function () {
      var _getCellSizeAndPositi16 = getCellSizeAndPositionManager(),
          ...
          cellSizeGetterCalls = _getCellSizeAndPositi16.cellSizeGetterCalls;

      cellSizeAndPositionManager.getSizeAndPositionOfCell(5);
      expect(cellSizeGetterCalls.mock.calls).toEqual([[0], [1], [2], [3], [4], [5]]);
    });
    it('should just-in-time measure cells up to the requested cell if some but not all cells have been measured', function () {
      var _getCellSizeAndPositi17 = getCellSizeAndPositionManager(),
          ...
          cellSizeGetterCalls = _getCellSizeAndPositi17.cellSizeGetterCalls;

      cellSizeAndPositionManager.getSizeAndPositionOfCell(5);
      cellSizeGetterCalls.mockClear();
      cellSizeAndPositionManager.getSizeAndPositionOfCell(10);
      expect(cellSizeGetterCalls.mock.calls).toEqual([[6], [7], [8], [9], [10]]);
    });
    it('should return cached size and position data if cell has already been measured', function () {
      var _getCellSizeAndPositi18 = getCellSizeAndPositionManager(),
          ...
          cellSizeGetterCalls = _getCellSizeAndPositi18.cellSizeGetterCalls;
  ...
  describe('getUpdatedOffsetForIndex numeric CellSize', function () {
    function getUpdatedOffsetForIndexHelper(_ref2) {
      var _ref2$align = _ref2.align,
          align = _ref2$align === void 0 ? 'auto' : _ref2$align,
          _ref2$cellCount = _ref2.cellCount,
          cellCount = _ref2$cellCount === void 0 ? 10 : _ref2$cellCount,
          _ref2$cellSize = _ref2.cellSize,
          cellSize = _ref2$cellSize === void 0 ? 10 : _ref2$cellSize,
          _ref2$containerSize = _ref2.containerSize,
          containerSize = _ref2$containerSize === void 0 ? 50 : _ref2$containerSize,
          _ref2$currentOffset = _ref2.currentOffset,
          currentOffset = _ref2$currentOffset === void 0 ? 0 : _ref2$currentOffset,
          _ref2$estimatedCellSi = _ref2.estimatedCellSize,
          estimatedCellSize = _ref2$estimatedCellSi === void 0 ? 15 : _ref2$estimatedCellSi,
          _ref2$targetIndex = _ref2.targetIndex,
          targetIndex = _ref2$targetIndex === void 0 ? 0 : _ref2$targetIndex;
      var cellSizeAndPositionManager = new CellSizeAndPositionManager({
        cellCount: cellCount,
        cellSize: cellSize,
        estimatedCellSize: estimatedCellSize
    ...
    it('should not scroll past the safe bounds even if the specified :align requests it', function () {
      ...
      expect(getUpdatedOffsetForIndexHelper({
        ...
        currentOffset: 0,
        targetIndex: 9
      })).toEqual(50); // In case it is a numeric cellSize we don't have the tricky situation
  ...
  describe('getUpdatedOffsetForIndex thunk CellSize', function () {
    function getUpdatedOffsetForIndexHelper(_ref3) {
      var _ref3$align = _ref3.align,
          ...
          cellSize = _ref3$cellSize === void 0 ? function () {
        return 10;
      } : _ref3$cellSize,
  ...
  describe('getVisibleCellRange', function () {
    ...
    it('should return a visible range of cells for the end of the list', function () {
      var _getCellSizeAndPositi27 = getCellSizeAndPositionManager(),
          cellSizeAndPositionManager = _getCellSizeAndPositi27.cellSizeAndPositionManager;
  ...
  describe('resetCell', function () {
    it('should clear size and position metadata for the specified index and all cells after it', function () {
      var _getCellSizeAndPositi28 = getCellSizeAndPositionManager(),
          cellSizeAndPositionManager = _getCellSizeAndPositi28.cellSizeAndPositionManager;
    ...
    it('should not clear size and position metadata for cells before the specified index', function () {
      var _getCellSizeAndPositi29 = getCellSizeAndPositionManager(),
          cellSizeAndPositionManager = _getCellSizeAndPositi29.cellSizeAndPositionManager,
          cellSizeGetterCalls = _getCellSizeAndPositi29.cellSizeGetterCalls;
    ...
    it('should not skip over any unmeasured or previously-cleared cells', function () {
      var _getCellSizeAndPositi30 = getCellSizeAndPositionManager(),
          cellSizeAndPositionManager = _getCellSizeAndPositi30.cellSizeAndPositionManager;
