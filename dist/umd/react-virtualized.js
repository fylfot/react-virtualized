   ...
   */    printWarning = function(text) {
    ...
    var win, CellSizeAndPositionManager = function() {
        function CellSizeAndPositionManager(_ref) {
            ...
            _defineProperty(this, "_cellCount", void 0), _defineProperty(this, "_cellSize", void 0), 
            _defineProperty(this, "_estimatedCellSize", void 0), this._cellCount = cellCount, 
        ...
        return _createClass(CellSizeAndPositionManager, [ {
            ...
            value: function(index) {
                if (this._validateIndex(index), index > this._lastMeasuredIndex) for (var lastMeasuredCellSizeAndPosition = this.getSizeAndPositionOfLastMeasuredCell(), offset = lastMeasuredCellSizeAndPosition.offset + lastMeasuredCellSizeAndPosition.size, i = this._lastMeasuredIndex + 1; i <= index; i++) {
                    var size = this._getSize(i);
